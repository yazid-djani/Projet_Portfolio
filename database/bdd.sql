...
-- --------------------------------------------------------
-- 1. Table groups (Modifiée pour inclure 'AUTRE')
-- --------------------------------------------------------
CREATE TABLE IF NOT EXISTS groups (
    group_id            INT UNSIGNED NOT NULL AUTO_INCREMENT PRIMARY KEY,
    name                VARCHAR(100) NOT NULL,
    type                ENUM('ECOLE', 'ENTREPRISE', 'AUTRE') NOT NULL, -- Ajout de AUTRE pour le groupe Monde
...
(
    ...
    group_id            INT UNSIGNED NULL, -- Clé étrangère vers la table groups
...
-- --------------------------------------------------------
-- 8. Données de test : Groupes
-- --------------------------------------------------------

-- Insertion des Groupes (AVEC LE GROUPE MONDE PAR DÉFAUT)
INSERT INTO groups (group_id, name, type, code) VALUES
(1, 'Monde', 'AUTRE', 'MONDE'),           -- ID 1 : Groupe par défaut
(2, 'École de Paris', 'ECOLE', 'ECOLE_PARIS'),
(3, 'Tech Corp', 'ENTREPRISE', 'TECH_CORP'),
(4, 'Université Lyon', 'ECOLE', 'UNIV_LYON'),
(5, 'Data Solutions', 'ENTREPRISE', 'DATA_SOLUTIONS');

-- --------------------------------------------------------
-- 8. Données de test : utilisateur + SuperAdmin
-- --------------------------------------------------------

-- Admin (NULL ou ID 1 'Monde', ici on met NULL pour l'admin global)
INSERT INTO users (user_lastname, user_firstname, user_email, user_age, password_hash, role, status, can_create_quiz, group_id)
VALUES ('Super', 'Admin', 'admin@quizzeo.com', 99, '$2y$10$hMHscKPrztyiDUYrH3SY/ufbnjndlcfl7ozS11VwDdTKfgfwkf3gS', 'admin', 'active', 1, NULL);

INSERT INTO users (user_lastname, user_firstname, user_email, user_age, password_hash, role, status, can_create_quiz, group_id)
VALUES
-- GROUPE 2 : "ECOLE_PARIS"
('Petit', 'Hugo', 'hugo.petit@quizzeo.com', 25, '$2y$10$/K9Vtxz6SLB7Ws7WwJBOIekL1vSzykI0LZpoVE/FU75icVf9gqVKu', 'ecole', 'active', 1, 2),
('Durand', 'Paul', 'paul.durand@quizzeo.com', 22, '$2y$10$/K9Vtxz6SLB7Ws7WwJBOIekL1vSzykI0LZpoVE/FU75icVf9gqVKu', 'utilisateur', 'active', 0, 2),
('Martin', 'Lina', 'lina.martin@quizzeo.com', 19, '$2y$10$/K9Vtxz6SLB7Ws7WwJBOIekL1vSzykI0LZpoVE/FU75icVf9gqVKu', 'utilisateur', 'active', 0, 2),
('Girard', 'Adam', 'adam.girard@quizzeo.com', 18, '$2y$10$/K9Vtxz6SLB7Ws7WwJBOIekL1vSzykI0LZpoVE/FU75icVf9gqVKu', 'utilisateur', 'active', 0, 2),

-- GROUPE 3 : "TECH_CORP"
('Robert', 'Emma', 'emma.robert@quizzeo.com', 23, '$2y$10$/K9Vtxz6SLB7Ws7WwJBOIekL1vSzykI0LZpoVE/FU75icVf9gqVKu', 'entreprise', 'active', 1, 3),
('Morel', 'Lucas', 'lucas.morel@quizzeo.com', 28, '$2y$10$/K9Vtxz6SLB7Ws7WwJBOIekL1vSzykI0LZpoVE/FU75icVf9gqVKu', 'utilisateur', 'active', 0, 3),

-- GROUPE 4 : "UNIV_LYON"
('Roux', 'Nicolas', 'nicolas.roux@quizzeo.com', 32, '$2y$10$/K9Vtxz6SLB7Ws7WwJBOIekL1vSzykI0LZpoVE/FU75icVf9gqVKu', 'ecole', 'active', 1, 4),
('Lambert', 'Sarah', 'sarah.lambert@quizzeo.com', 24, '$2y$10$/K9Vtxz6SLB7Ws7WwJBOIekL1vSzykI0LZpoVE/FU75icVf9gqVKu', 'utilisateur', 'active', 0, 4),

-- GROUPE 5 : "DATA_SOLUTIONS"
('Fournier', 'Elisa', 'elisa.fournier@quizzeo.com', 26, '$2y$10$/K9Vtxz6SLB7Ws7WwJBOIekL1vSzykI0LZpoVE/FU75icVf9gqVKu', 'entreprise', 'active', 1, 5),

-- GROUPE 1 : "MONDE" (Utilisateur sans code spécifique)
('Lefevre', 'Chloe', 'chloe.lefevre@quizzeo.com', 21, '$2y$10$/K9Vtxz6SLB7Ws7WwJBOIekL1vSzykI0LZpoVE/FU75icVf9gqVKu', 'utilisateur', 'active', 0, 1);
...
-- Quiz 2 : Culture G (brouillon, visible uniquement par TECH_CORP ID 3)
(2, 6, "Culture d\'Entreprise", 'Test interne pour les employés de Tech Corp.', 'entreprise', 'brouillon', 'private', '2025-01-02 11:00:00', '2025-01-06 09:00:00', NULL),

-- Quiz 3 : Sport (published)
(3, 3, 'Quiz Sport', 'Questions sur le sport et ses règles.', 'utilisateur', 'published', 'public', '2025-01-03 12:00:00', NULL, NULL);

-- --------------------------------------------------------
-- 10. Données de test : Questions & Choix
-- --------------------------------------------------------
