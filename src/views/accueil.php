...
<body>
    ...
    <div class="landing-container">
        <h1 class="landing-title">Salut ! C'est Quizzeo, une plateforme qui propose des quiz à tout les niveaux</h1>
        <p class="landing-text">
            La plateforme ultime pour créer, partager et jouer à des quiz en temps réel.
            De l'ecole à l'entrepreunariat, rejoignez-nous !
        </p>
        ...
        <div class="btn-group">
            ...
            <a href="index.php?route=informationentreprise" class="btn-landing btn-secondary">informartion entreprise</a>
            
            <a href="index.php?route=informationutilisateur" class="btn-landing btn-secondary">Information utilisateur</a>

            <a href="index.php?route=informationecole" class="btn-landing btn-secondary">Information ecole</a>
