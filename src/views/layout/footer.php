<footer class="site-footer">
    ...
    <div class="footer-bottom">
        ...
        <p style="font-size: 12px; opacity: 0.6; margin-top: 5px;">Template original créé par <a href="https://yazid-djani.dev" target="_blank" style="color: inherit; text-decoration: underline;">Yazid Djani</a></p>
    </div>
</footer>